...
uses
  ...
  ZDataset, rxcurredit, connect, Global, fpjson, jsonparser;
...
begin
 ...
 Connection:=DataModule2.ZCon1;
    ...
    sql.Text:='INSERT INTO GOODS_SPU '
       +'(GOODS_ID, GOODS_NAME, GOODS_NAME2,  ENA, CODE, CLASS_ID, CATEGORY_ID, BRAND_ID, TYPE, UNIT,  TAXRATE_ID, WEIGTH, VOLUME, IS_ACTIVE, PARENT_ID)'
       +'VALUES (:GOODS_ID, :GOODS_NAME, :GOODS_NAME2, :ENA, :CODE, :CLASS_ID, :CATEGORY_ID, :BRAND_ID, :TYPE, :UNIT, :TAXRATE_ID, :WEIGTH, :VOLUME, :IS_ACTIVE, :PARENT_ID) '
       +'ON DUPLICATE KEY UPDATE '
       +'GOODS_NAME=:GOODS_NAME, GOODS_NAME2=:GOODS_NAME2, CODE=:CODE, CLASS_ID=:CLASS_ID, CATEGORY_ID=:CATEGORY_ID, '
       +'TYPE=:TYPE, UNIT=:UNIT, '
       +'BRAND_ID=:BRAND_ID, TAXRATE_ID=:TAXRATE_ID, WEIGTH=:WEIGTH, VOLUME=:VOLUME, IS_ACTIVE=:IS_ACTIVE ';
